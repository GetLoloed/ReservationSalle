...
// timezone the ReservationSalleMRBS server runs in.  See the INSTALL document for more information.
//
...
// time to time to see if there is a later version available on the ReservationSalleMRBS.   If your
// site prevents external access to the ReservationSalleMRBS, this check will time out.  However
...
// areas: this is done by editing the settings for an area using a ReservationSalleMRBS browser by
