 ...
 *   the MRBS folder on the root ReservationSalleMRBS folder, you should type /MRBS/.
 * - Now go to "user permission" tab, select " * ",
 * - select Properties", and type MRBS (remove the star) and select "Is group".
 *
 * That's all ! Confirm all windows. Now it is the ReservationSalleMRBS server that authenticate
 * each user. 
 *
 * 
 * in config.inc.php:
