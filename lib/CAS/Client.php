...
class CAS_Client
{
    ...
    */
    ...
    /**
     * The class to instantiate for making ReservationSalleMRBS requests in readUrl().
    ...
    /**
     * Override the default implementation used to make ReservationSalleMRBS requests in readUrl().
    ...
    */
    ...
    private function _setProxies($proxies)
    {
        ...
        if (!empty($proxies)) {
            ...
            // ReservationSalleMRBS-service call.
            // Because of this, stripping the ticket from the URL is unnecessary
            // and causes another ReservationSalleMRBS-service request to be performed. Additionally,
